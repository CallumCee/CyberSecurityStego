...
public class FileReader {
	...
	private void populateSizeBits(){
		...
		String binaryFileSize = Long.toBinaryString(0x100000000L + getFileSize()).substring(1);

		for(char c : binaryFileSize.toCharArray()){
			sbits.add(Character.getNumericValue(c));
		}
